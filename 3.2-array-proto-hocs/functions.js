...
function showName(array) {
	let weaponName = array.forEach(element => console.log(element.name));
	return weaponName;
}

function showDurability(array,number) {
	let weaponDurability = array.filter(element => element.durability > number);
	return weaponDurability.length;
}

function hasReliableWeapons(array,number) {
	let reliableWeapon = array.some(element => element.durability == number);
	return reliableWeapon;
}

function getReliableWeaponsNames(array,number) {
	let reliableWeaponName = array.filter(element => element.durability > number);
	return weaponNames = reliableWeaponName.forEach(element => console.log(element.name));
}
